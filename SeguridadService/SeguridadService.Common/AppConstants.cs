...
namespace SeguridadService.Common
{
    public static class AppConstants
    {
        ...
        {
            public const string LogueoFallido = "Usuario y/o password inválidos";
            public const string UsuarioInactivo = "El usuario se encuentra inactivo. No puede iniciar sesión.";
            public const string CredencialesInvalidas = "Credenciales inválidas";
            public const string LoginOk = "Inicio de sesión exitoso";
        }
    }
}
